...
paths_to_data = [str(cwd) + '/dataset/bench/geopotential_500/*.nc',str(cwd) + '/dataset/bench/temperature_850/*.nc',str(cwd) + '/dataset/bench/2m_temperature/*.nc',str(cwd) + '/dataset/bench/10m_u_component_of_wind/*.nc',str(cwd) + '/dataset/bench/10m_v_component_of_wind/*.nc']
const_info_path = [str(cwd) +  '/dataset/bench/constants/constants_5.625deg.nc']
