...
train_time_scale= slice('2008','2016')
val_time_scale = slice('2016','2016')
test_time_scale = slice('2017','2018')

print(str(cwd))
data_path = '/nfs/stak/users/gaosho/hpc-share/dataset/climate'

paths_to_data = [data_path + '/geopotential_500_5.625deg/*.nc',data_path + '/temperature_850_5.625deg/*.nc',data_path + '/2m_temperature_5.625deg/*.nc',data_path + '/10m_u_component_of_wind_5/*.nc',data_path + '/10m_v_component_of_wind_5/*.nc']
const_info_path = [data_path +  '/constants_5.625deg.nc']
