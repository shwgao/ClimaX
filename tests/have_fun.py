...
def start_record_memory_history() -> None:
    ...
    torch.cuda.memory._record_memory_history(
        ...
        enabled=True,
        trace_alloc_max_entries=MAX_NUM_OF_MEM_EVENTS_PER_SNAPSHOT
    )
...
def export_memory_snapshot() -> None:
    ...
    try:
        logger.info(f"Saving snapshot to local file: ./profile/climax/{file_prefix}.pickle")
        torch.cuda.memory._dump_snapshot(f"./profile/climax/{file_prefix}.pickle")
